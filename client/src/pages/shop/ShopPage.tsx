...
export default function ShopPage() {
  ...
  const pillClass = (active: boolean) =>
    [
      'font-body text-[10px] tracking-[0.18em] uppercase px-4 py-2 border transition-colors duration-150 whitespace-nowrap',
      active
      ...
      <main className="pt-[72px]">
        ...
        <div className={`${px} py-12 border-b border-border`}>
          <div className="flex items-baseline justify-between">
            <h1 className="font-display text-4xl md:text-5xl text-ink">Collection</h1>
        ...
        {/* ── Filter + Sort bar ─────────────────────────────────── */}
        <div className={`${px} py-5 border-b border-border flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4`}>
          {/* Category pills */}
          ...
          <select
            ...
            className="self-start sm:self-auto font-body text-[10px] tracking-[0.15em] uppercase border border-border bg-bg px-4 py-2 text-ink-2 outline-none focus:border-ink transition-colors cursor-pointer"
          >
        ...
        <div className={`${px} py-16`}>
          {loading ? (
            ...
            <div className="py-32 text-center border border-border">
              <p className="font-display text-2xl text-ink-2 mb-6">
